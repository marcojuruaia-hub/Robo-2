...
CONFIG = {
    ...
    "TOKEN_ID": "24120579393151285531790392365655515414663383379081658053153655752666989210807",  # BTC UP
    "PROXY": "0x658293eF9454A2DD555eb4afcE6436aDE78ab20B",
    
    # 🔽 ESTRATÉGIA DE COMPRA
    "PRECO_MAX_COMPRA": 0.68,     # Começa comprando a 0.80
    ...
    "INTERVALO_TEMPO": 60,        # Tempo entre ciclos (segundos)
